'use strict';
 ...
 function noAnswerMes(event){    
    ...
    var q =[
		...
		'<div><h3>2.Which of the following defines 1% of viewport height?  </h3><input type="radio" name="q2" value="a" id="q2a"> px <br><input type="radio" name="q2" value="b" id="q2b">vmin<br><input type="radio" name="q2" value="c" id="q2c"> vw<br><input type="radio" name="q2" value="d" id="q2d">  vh <br></div>',
        '<div><h3>3. __________ is a property that allows developers to add rounded corners on the design elements </h3><input type="radio" name="q3" value="a" id="q3a"> Round Corner;<br><input type="radio" name="q3" value="b" id="q3b">  Box Shadow;<br><input type="radio" name="q3" value="c" id="q3c"> Border-Radius;<br> <input type="radio" name="q3" value="d" id="q3d"> Corner; <br></div>',
        '<div><h3>4. How to rotate objects using CSS3? </h3><input type="radio" name="q4" value="a" id="q4a"> object-rotation: 30deg;<br><input type="radio" name="q4" value="b" id="q4b">rotate-object: 30deg; <br><input type="radio" name="q4" value="c" id="q4c"> transform: rotate-30deg-clockwise;<br><input type="radio" name="q4" value="d" id="q4d"> transform: rotate(30deg);<br></div>',
        ...
        '<div><h3>6. Box-Shadow is a property that allows developers to apply a....</h3><input type="radio" name="q6" value="a" id="q6a"> Border<br><input type="radio" name="q6" value="b" id="q6b">  Rounded Corner<br><input type="radio" name="q6" value="c" id="q6c"> Drop Shadow<br> <input type="radio" name="q6" value="d" id="q6d"> Background<br></div>',
        '<div><h3>7. What are the first three values of text-shadow in order?</h3><input type="radio" name="q7" value="a" id="q7a"> vertical, horizontal, blur<br><input type="radio" name="q7" value="b" id="q7b"> blur, vertical, horizontal <br><input type="radio" name="q7" value="c" id="q7c"> horizontal, vertical, blur <br> <input type="radio" name="q7" value="d" id="q7d">vertical, blur, horizontal <br></div>',
        '<div><h3>8. How to force a word wrap using CSS3?</h3><input type="radio" name="q8" value="a" id="q8a"> text-wrap: break-word;<br><input type="radio" name="q8" value="b" id="q8b">word-wrap: break-word; <br><input type="radio" name="q8" value="c" id="q8c"> text-wrap: force;<br><input type="radio" name="q8" value="d" id="q8d"> text-width: set;<br></div>',
